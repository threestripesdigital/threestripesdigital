export function gridMetrics(data) {
 ...
 const play=wc('play','VSL play rate',v.play_rate,'percent');play.sample=v.unique_loads??null;
 play.recommendation=videoNote+'. Plays relative to player loads. Includes prelaunch views and all embed locations; not a paid-only benchmark.';
